...
ModelType = TypeVar("ModelType") #Criação do tipo genérico refente a entidade

#Classe Abstrata do repository
class BaseRepository(Generic[ModelType]):
    def __init__(self, model: Type[ModelType], db: AsyncSession):
        self.model = model #Entidade recebida
        self.db = db #Conexão comdatabase
